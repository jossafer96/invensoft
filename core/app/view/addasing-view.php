...
//			echo ">>".$q;
			if($c["q"]<=$q){
				...
				$error = array("product_id"=>$c["product_id"],"message"=>"No hay suficiente cantidad de equipo/producto en inventario.");
...
if($_POST["q"]<=$q){
	...
	$error = array("product_id"=>$_POST["product_id"],"message"=>"No hay suficiente cantidad de equipo/producto en inventario.");
	$errors[count($errors)] = $error;
	$can=false;
}
